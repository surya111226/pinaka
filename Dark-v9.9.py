...
logo = """
\033[1;91m mmmm     mm   mmmmm  m    m        mmmmmm mmmmm
 #   "m   ##   #   "# #  m"         #      #    #
 #    #  #  #  #mmmm" #m#           #mmmmm #mmmm"
\033[1;37m #    #  #mm#  #   "m #  #m         #      #    #
 #mmm"  #    # #    " #   "m   #    #      #mmmm"
...
def login():
	...
	try:
		...
		print('\033[1;34m[☆] \x1b[1;93mLOGIN AKUN FACEBOOK ANDA \x1b[1;34m[☆]' )
		id = raw_input('\033[1;34m[+] \x1b[1;93mID/Email \x1b[1;91m: \x1b[1;92m')
		pwd = raw_input('\033[1;34m[+] \x1b[1;93mPassword \x1b[1;91m: \x1b[1;92m')
		tik()
		try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCcQ8VXRTHoqy_nvRDDTCLXw')
				menu()
...
def pilih_super():
	...
	print
	print('\x1b[1;96m[!] \x1b[0;1mTunggu Sebentar njirr :v')
	print 42*"\033[1;96m="
